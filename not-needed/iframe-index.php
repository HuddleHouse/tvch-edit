...
<body>
	Select from the two button drop down menus:
    		...
    		<div class="col-md-12">
	    		...
	    		<div class="dropdown">
				  ...
				  <ul class="dropdown-menu">
				  	<li class="counties county-all"><a id='all' class="county">All Counties</a></li>
					  ...
					  while ($row = $result->fetch_assoc()){
							...
							echo '<li class="counties county-'.$id.'"><a id="'.$id.'" class="county">'.$county.'</a></li>';
						}
					  ?>
				  </ul>
				</div>
	    		...
	    		<div class="dropdown">
				  ...
				  <ul class="dropdown-menu">
				  <li class="offers offer-all"><a id='all' class="offer">All Services</a></li>
				  <li role="presentation" class="divider"></li>
					  <?php
					  ...
					  while ($row = $result->fetch_assoc()){
							extract($row);
							echo '<li class="offers offer-'.$id.'"><a id="'.$id.'" class="offer">'.$servtype.'</a></li>';
						}
					  ?>
				  </ul>
				</div>
	...
	<div style="height:1000px; width:0px; background-color: none transparent;"></div>
